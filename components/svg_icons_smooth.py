...
def show_svg_icon(icon_name, width=24, height=24, animation="smoothBlink", color="#3B82F6"):
    ...
    svg_icons = {
        "alert-circle": f"""
<svg width = (
            "{width}" height="{height}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="smooth-icon">
        )
            <style>
...
<path d = (
                "M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1 .34-4.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z" stroke="{color}" stroke-width="2" fill="none"/>
            )
<path d = (
                "M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0-.34-4.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z" stroke="{color}" stroke-width="2" fill="none"/>
            )
        </svg>
        """,
...
<path d = (
                "M13 22H7a5 5 0 1 1 4.9-6H13a3 3 0 0 1 0 6Z" stroke="{color}" stroke-width="2" fill="none"/>
            )
...
<path d = (
                "M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z" stroke="{color}" stroke-width="2" fill="none"/>
            )
            <path d="M12 2v2" stroke="{color}" stroke-width="2" stroke-linecap="round"/>
        </svg>
        """,
...
<path d = (
                "M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2" stroke="{color}" stroke-width="2" stroke-linecap="round"/>
            )
...
<path d = (
                "M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8" stroke="{color}" stroke-width="2" stroke-linecap="round"/>
            )
            <path d="M21 3v5h-5" stroke="{color}" stroke-width="2" stroke-linecap="round"/>
<path d = (
                "M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16" stroke="{color}" stroke-width="2" stroke-linecap="round"/>
            )
...
<path d = (
                "M22 11.08V12a10 10 0 1 1-5.93-9.14" stroke="{color}" stroke-width="2" stroke-linecap="round"/>
            )
...
<path d = (
                "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" stroke="{color}" stroke-width="2" fill="none"/>
            )
...
<path d = (
                "M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" stroke="{color}" stroke-width="2" fill="none"/>
            )
        </svg>
        """,
...
<path d = (
                "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" stroke="{color}" stroke-width="2" fill="none"/>
            )
...
<path d = (
                "M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" stroke="{color}" stroke-width="2" fill="none"/>
            )
        </svg>
        """,
...
<path d = (
                "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="{color}" stroke-width="2" fill="none"/>
            )
...
<path d = (
                "M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" stroke="{color}" stroke-width="2" fill="none"/>
            )
...
<path d = (
                "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" stroke="{color}" stroke-width="2" fill="none"/>
            )
...
<svg width = (
            ...
            <circle cx="12" cy="12" r="10" stroke="{color}" stroke-width="2" fill="none"/>
<path d = (
                "M16.24 7.76l-2.12 6.36-6.36 2.12 2.12-6.36 6.36-2.12z" stroke="{color}" stroke-width="2" fill="none"/>
            )
        </svg>
        """,
...
def get_icon_colors():
    ...
    return {
        "settings": """
<svg width = (
            "24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="smooth-icon">
        )
            <style>
                @keyframes smoothBlink {{
                    0%, 100% {{ opacity: 1; transform: scale(1); }}
